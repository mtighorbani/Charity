...
const OurMissionBox = () => {
  return (
    <>
      <TextBox
        title="#دیدگا ما"
        className="shadow-lg shadow-blue/40 ring-blue mt-40 max-sm:p-5  p-10 max-sm:w-[90%] md:max-w-[60%] "
      >
        در ایدنیک، ما با ارائه فرصت برنده شدن جوایز بزرگ، پول برای خیریه
